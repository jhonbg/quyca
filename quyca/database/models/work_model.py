...
class BiblioGraphicInfo(BaseModel):
    bibtex: str | Any | None = None
    end_page: str | Any | None = None
    volume: str | int | None = None
    issue: str | Any | None = None
    open_access_status: str | Any | None = None
    pages: str | Any | None = None
    start_page: str | Any | None = None
    is_open_access: bool | Any | None = None
...
class Work(BaseModel):
    ...
    year_published: int | str | None = None
    bibliographic_info: BiblioGraphicInfo | None = Field(default_factory=list)
