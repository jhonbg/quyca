...
class WorkRepository:
    ...
    def get_works_by_affiliation(
        ...
        pipeline = cls.process_params(pipeline, query_params, pipeline_params)
    ...
    def get_works_count_by_affiliation(
            cls, affiliation_id: str, affiliation_type: str, filters: dict | None = None
    ) -> int:
    ...
    @classmethod
    def get_sources_by_person(cls, person_id: str, query_params, pipeline_params: dict | None = None) -> Generator:
        if pipeline_params is None:
            pipeline_params = {}

        pipeline = cls.get_sources_by_person_pipeline(person_id)
    ...
    @classmethod
    def process_params(cls, pipeline, query_params, pipeline_params: dict | None = None):
        if pipeline_params is None:
            pipeline_params = {}
