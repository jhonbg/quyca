...
def get_affiliation_plot(affiliation_id: str, affiliation_type: str, plot_type: str, query_params: MultiDict):
    ...
    if plot_type in ["products_faculty", "products_department", "products_group"]:
        relation_type = plot_type.split("_")[-1]
        return plot_products_by_affiliation(affiliation_id, affiliation_type, relation_type)
