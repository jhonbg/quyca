...
def test_it_can_plot_h_index_by_faculty_by_institution(client):
    response = client.get(
        f"/app/affiliation/institution/{random_affiliation_id}/research/products?plot=h_index_by_faculty"
    )
...
def test_it_can_plot_h_index_by_faculty_by_department(client):
    response = client.get(
        f"/app/affiliation/department/{random_affiliation_id}/research/products?plot=h_index_by_faculty"
    )
